 ...
 * - Extends BaseCommand for consistent error handling
 */
    ...
    switch (property.toLowerCase()) {
      case "name":
        ...
        if (success) {
          ...
          view.displayError("Calendar '" + calendarName + "' not found or name '"
      ...
      case "timezone":
        ...
        try {
          ...
          if (success) {
            ...
            view.displayError("Calendar '" + calendarName + "' not found.");
          }
        } catch (ZoneRulesException e) {
          view.displayError("Invalid timezone '" + newValue + "'. "
      ...
      default:
        view.displayError("Unknown property '" + property + "'. "
