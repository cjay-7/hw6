...
public class CalendarManager {
  private final Map<String, CalendarInterface> calendars;
  private CalendarInterface currentCalendar;
  ...
  public boolean setCurrentCalendar(String name) {
    CalendarInterface calendar = getCalendar(name);
    if (calendar == null) {
      return false;
    }
   ...
   */
  public CalendarInterface getCurrentCalendar() {
  ...
  public boolean editCalendarName(String oldName, String newName) {
    ...
    CalendarInterface calendar = getCalendar(oldName);
    if (calendar == null) {
      return false;
    }
