...
public class CommandTests {
   ...
   * TC 3: This test verifies that a single event is created with the required
   * parameters.
   */
  @Test
  ...
  public void testEditEventCommandInvalidProperty() throws IOException {
    ...
    assertFalse("Should return false for invalid property", result);
  }
  ...
  public void testExportCommand() throws IOException {
    ...
    Path tempFile = Path.of("test-export-" + System.currentTimeMillis() + ".csv");
    try {
